...
// node_modules/written-numbers/dist/wasm/written_numbers_wasm.js
var wasm;
...
function to_words(number, options, language_options) {
  ...
  const ret = wasm.to_words(ptr0, len0, addHeapObject(options), addHeapObject(language_options));
...
var written_numbers_wasm_default = init;

// node_modules/written-numbers/dist/index.js
var dist_default = written_numbers_wasm_default;
function toWords({ number, options, languageOptions }) {
  number ?? (number = "");
...
//# sourceMappingURL=written-numbers.js.map
